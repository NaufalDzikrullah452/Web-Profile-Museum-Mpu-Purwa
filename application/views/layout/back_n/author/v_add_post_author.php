<!-- page title area start -->
                    ...
                    <div class="col-sm-6 clearfix">
                        <div class="user-profile pull-right">
                            ...
                            <div class="dropdown-menu">
                                <a class="dropdown-item" href="<?php echo base_url('index.php/back_n/change_pass_author');?>"><i class="fa fa-key"></i> Ubah Password</a>
            ...
            <div class="main-content-inner">
                ...
                <div class="row">
                 <form action="<?php echo base_url().'index.php/back_n/author/post_author/publish'?>" method="post" enctype="multipart/form-data">
                 <div class="row">
