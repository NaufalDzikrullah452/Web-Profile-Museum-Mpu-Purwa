  <!-- page title area start -->
            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <!-- Modal Add Start -->
                                <form  action="<?php echo base_url().'index.php/back_n/author/tag_author/save'?>" method="post">
                            ...
                            <!-- Modal Edit Start -->
                                <form  action="<?php echo base_url().'index.php/back_n/author/tag_author/edit'?>" method="post">
                             ...
                             <!-- Modal Delete-->
                            <form  action="<?php echo base_url().'index.php/back_n/author/tag_author/delete'?>" method="post">
