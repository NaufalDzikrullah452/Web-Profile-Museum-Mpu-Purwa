            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <!-- Dark table end -->
                     ...
                     <!-- Modal Add Start -->
                                <form  action="<?php echo base_url().'index.php/back_n/author/category_author/save'?>" method="post">
                             ...
                             <!-- Modal Add End -->
                              ...
                              <!-- Modal Edit Start -->
                                <form  action="<?php echo base_url().'index.php/back_n/author/category_author/edit'?>" method="post">
                             ...
                             <!-- Modal Delete-->
                            <form  action="<?php echo base_url().'index.php/back_n/author/category_author/delete'?>" method="post">
