<!-- page title area start -->
                ...
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        <div class="breadcrumbs-area clearfix">
                            <h4 class="page-title pull-left">Komentar Artikel</h4>
            ...
            <div class="main-content-inner">
                ...
                <div class="row">
                    ...
                    <div class="search-box pull-right">
                            <form action="<?php echo site_url('index.php/back_n/author/comment_author/results');?>" method="GET" data-default="150">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <ul class="nav nav-tabs" id="myTab" role="tablist">
                                    <li class="nav-item">
                                        <a class="nav-link" href="<?php echo site_url('index.php/back_n/author/comment_author');?>">Semua <span class="badge badge-info"><?php echo $total_all;?></span></a>
                                    </li>
                                    <li class="nav-item" class="active">
                                        <a class="nav-link active" id="profile-tab" data-toggle="tab" href="#unpublish" role="tab"  aria-selected="true">Tinjauan <span class="badge badge-danger"><?php echo $total_rows;?></span></a>
                                    </li>
                                </ul>
                                <div class="tab-content mt-3" id="myTabContent">
                            <!-- Unpublish -->
                            <div class="tab-pane fade show active" id="unpublish" role="tabpanel" aria-labelledby="profile-tab">
                            ...
                            <div class="card-body">
                                ...
                                <div class="pull-right m-r-md">
                                    <div class="btn-group">
                                     ...
                                     <div class="dropdown-menu btn-xs dropdown-menu-right" role="menu">
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-1"><a href="<?php echo site_url('index.php/blog/'.$row->post_slug);?>" target="_blank"><?php echo $row->post_title;?></a></h4> 
                                ...
                                <div class="mt-5 child-media">
                                    <div class="pull-left m-r-md">
                                    <img class="img-fluid mr-4" src="<?php echo base_url().'uploas/user/user_blank.png'?>" width="80" height="80"  alt="<?php echo $row->comment_name?>">
                                    </div>
                                <div class="pull-right m-r-md">
                                  <div class="btn-group">
                                     <button type="button" class="btn btn-defaultbtn-xs dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
                                      Action <span class="caret"></span>
                                     </button>
                                    ...
                                    <div class="media-body">
                                        <h4 class="mb-3 text-info"><a href="<?php echo site_url('index.php/blog/'.$row->post_slug);?>" target="_blank"><?php echo $row->post_title;?></a></h4> 
        ...
        <!-- MODAL REPLY -->
        <form action="<?php echo site_url('index.php/back_n/author/comment_author/reply');?>" method="post">
        ...
        <!-- MODAL EDIT -->
        <form action="<?php echo site_url('index.php/back_n/author/comment_author/edit');?>" method="post">
        ...
        <!--PUBLISH MODAL-->
        <form action="<?php echo site_url('index.php/back_n/author/comment_author/publish');?>" method="post">
        ...
        <!--DELETE RECORD MODAL-->
        <form action="<?php echo site_url('index.php/back_n/author/comment_author/delete');?>" method="post">
        ...
        <!--CHANGE IMAGE MODAL-->
        <form action="<?php echo site_url('index.php/back_n/author/comment_author/change');?>" method="post" enctype="multipart/form-data">
