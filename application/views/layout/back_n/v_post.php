            ...
            <div class="main-content-inner">
                <div class="row">
                    ...
                    <div class="col-12 mt-5">
                        <div class="card">
                            <div class="card-body">
                                <a href="<?php echo site_url('index.php/back_n/post/add_new');?>" class="btn btn-info btn-sm mb-3">Tambah Baru</a>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td style="text-align: center;">
                                                        <a href="<?php echo site_url('index.php/back_n/post/get_edit/'.$row->post_id);?>" class="btn btn-xs"><span class="fa fa-pencil"></span></a>
                    ...
                    <!-- Dark table end -->
                             <!-- Modal hapus-->
        <form action="<?php echo site_url('index.php/back_n/post/delete');?>" method="post">
