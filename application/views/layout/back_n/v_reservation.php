                                           ...
                                           <?php 
                                            ...
                                            <tr>
                                                ...
                                                <?php if($row->reserv_status_message=='1')
                                                    {   echo "<i class='fa fa-check-circle' style='color: #27ae60;'></i>";
                                                    }else{
                                                        echo '<i class="fa fa-minus-circle" style="color: #d63031;"></i>';
                                                    }?>
                                                </td>
                                                ...
                                                <div class="btn-group">
                                                        ...
                                                        <div class="dropdown-menu dropdown-menu-right" role="menu">
                                                            <a class="dropdown-item" href="javascript:void(0);" data-toggle="modal" data-target="#ModalEdit<?php echo $row->reserv_id;?>"><i class="fa fa-edit"></i> Edit</a>
